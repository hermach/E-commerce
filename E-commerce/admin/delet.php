...
$select = $db->query('SELECT * FROM items');
...
<body>
    ...
    <div class="w3-bar w3-black" style="padding-left: 350px;" !-- id="Sidebar"  --> >
        ...
        <a href="#" class="w3-bar-item w3-button py-5"><i class="fa fa-trash"></i> Delet article</a>
    ...
    <div class="w3-container page-content">
        ...
        <table class="table">
                ...
                <?php foreach($items as $item):?>
                  <tr>
                    <th scope="row" name='id_items'><?= $item['id_items'];?></th>
                    <td><?= $item['title'];?></td>
                    <td><?= $item['des'];?></td>
                    <td class="text-center"><?= $item['catg'];?></td>
                    <td class="text-center"><?= $item['price'];?></td>
                    <td><img src="../img/items/<?= $item['img'];?>" width="200px"></td>
                    <td><a href="delet.php?id_items=<?=$item['id_items']; ?>"><i class="fas fa-trash-alt"></i></a></td>
                  </tr>
                <?php endforeach;?>
